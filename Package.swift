...
let package = Package(
    ...
    targets: [
        ...
        .target(
            name: "PagesMCPCore",
            dependencies: ["PagesBridge", .product(name: "MCP", package: "swift-sdk")]
        ),
        .executableTarget(
            name: "apple-pages-mcp",
            dependencies: ["PagesMCPCore"],
        ...
        .testTarget(name: "PagesMCPCoreTests", dependencies: ["PagesMCPCore"]),
    ]
)
