...
#
# Verified on macOS 26.5, by the sibling apple-notes-mcp repo: `codesign --force --sign -`
# turns flags=0x20002 (adhoc,linker-signed) into flags=0x2 (adhoc), and the embedded
# Info.plist survives.
#
